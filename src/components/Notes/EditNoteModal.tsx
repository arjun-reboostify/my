  ...
  return (
    ...
    >
      <motion.div
        ...
        className="editor-container border-2 relative border-gray-200 rounded-md py-3 px-1 md:px-4 bg-black text-white w-full max-w-2xl flex flex-col items-stretch shadow-lg"
      >
        <div className="flex flex-row justify-between items-start">
          <input
            ref={titleRef}
            className="font-semibold bg-black text-white text-xl mb-2.5 outline-none flex-1"
            value={title}
