...
const ContactPolicy = () => {
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-2xl shadow-md mt-10 space-y-8">
      {/* Contact Section */}
      <section>
        <h2 className="text-2xl font-bold text-gray-800 mb-4">Contact Us / Legal Policy</h2>
        <div className="space-y-4 text-gray-700">
          <div>
            <span className="font-semibold">Trade name:</span>Reboostify
          </div>
          <div>
            <span className="font-semibold">Phone number:</span> <span className="text-gray-500 italic">+91 8076008591</span>
          </div>
          <div>
            <span className="font-semibold">Email:</span>{' '}
            <a href="mailto:unidimensia@gmail.com" className="text-blue-600 hover:underline">
              unidimensia@gmail.com
            </a>
          </div>
          <div>
            <span className="font-semibold">Physical address:</span> India
          </div>
...
Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at unidimensia@gmail.com.
        </p>
      </section>
...
Questions about the Terms of Service should be sent to us at unidimensia@gmail.com.
Our contact information is posted below:
Reboostify
unidimensia@gmail.com
A1/172,phase 5 , ayanagar, new delhi
+91 8076008591

        </p>
      </section>
      <section>
        <h3 className="text-xl font-bold text-gray-800 mb-2">Return and Refund Policy</h3>
        <p className="text-gray-700 text-sm">
       We have a 30-day return policy, which means you have 30 days after receiving your item to request a return.

To be eligible for a return, your item must be in the same condition that you received it, unworn or unused, with tags, and in its original packaging. You’ll also need the receipt or proof of purchase.

To start a return, you can contact us at unidimensia@gmail.com. Please note that returns will need to be sent to the following address: [INSERT RETURN ADDRESS]

If your return is accepted, we’ll send you a return shipping label, as well as instructions on how and where to send your package. Items sent back to us without first requesting a return will not be accepted.

You can always contact us for any return question at unidimensia@gmail.com.
...
If more than 15 business days have passed since we’ve approved your return, please contact us at unidimensia@gmail.com.
        </p>
      </section>
      <section>
        <h3 className="text-xl font-bold text-gray-800 mb-2">Shipping Policy</h3>
        <p className="text-gray-700 text-sm">
        Shipping & Delivery Policy
Effective Date: June 2, 2025

1. 📘 Digital Course Access
Instant Access: Upon successful payment, you will receive immediate access to your purchased courses through your registered account.

Confirmation Email: A confirmation email with course details and access instructions will be sent to your registered email address.

No Physical Shipping: As our offerings are entirely digital, there are no shipping charges or physical deliveries involved.
balujaclasses.in
+1
Learning Destiny
+1

2. 📦 Physical Course Materials (If Applicable)
Availability: In cases where physical materials (e.g., printed study guides) are provided, they will be shipped within India only.

Processing Time: Orders for physical materials are processed within 1-3 business days.

Delivery Timeframe: Once dispatched, delivery typically takes 3-7 business days, depending on your location.

Shipping Charges: Shipping fees for physical materials will be calculated based on the delivery address and will be displayed at checkout.

Tracking Information: You will receive a tracking ID via email/SMS once your order has been dispatched.
Learning Destiny
+2
balujaclasses.in
+2
...
3. 🚚 Delivery Partners
We collaborate with reputable courier services to ensure timely and secure delivery of any physical materials.
techpeek.in
+2
balujaclasses.in
+2
...
4. 🛑 Delivery Issues
Incorrect Address: Please ensure that the delivery address provided during registration is accurate and complete. We are not responsible for delays or non-delivery due to incorrect or incomplete addresses.

Failed Delivery Attempts: If a delivery attempt fails due to recipient unavailability, our courier partners will make additional attempts as per their policy.

Damaged or Lost Shipments: In the rare event of damage or loss during transit, please contact our support team within 48 hours of the expected delivery date.
teacherspride.in
balujaclasses.in

5. 💳 Refund and Cancellation Policy
Digital Products: Due to the nature of digital content, we do not offer refunds or cancellations once access has been granted.

Physical Products: Returns and refunds for physical materials are subject to our Refund Policy. Please refer to the Refund Policy section on our website for detailed information.
techpeek.in

6. 🏛️ Governing Law and Jurisdiction
This policy is governed by the laws of India. Any disputes arising under or in connection with this policy shall be subject to the exclusive jurisdiction of the courts located in [Your City], India.

7. 📞 Contact Us
For any questions or concerns regarding this Shipping & Delivery Policy, please contact us at:

Email: unidimensia@gmail.com
